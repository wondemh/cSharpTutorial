    ...
    internal class IKFMemorySupportSectionBuilder : OccupancySectionBuilder
    {
        ...
        internal IKFMemorySupportSectionBuilder(DateTime reportDate)
        {
            ...
            memorySupportBudget = new IKFMemorySupportBudget
            {
                ...
                PrivateMCFirstPerson = OccupancyReportDAO.GetBudgetData(LocationCode.IKF, "MS", "Private - MC - 1st Person", reportDate.Year),
                PrivateMCSecondPerson = OccupancyReportDAO.GetBudgetData(LocationCode.IKF, "MS", "Private - MC - 2nd Person", reportDate.Year)
            };
        }
