    ...
    public class IKFSkilledNurseSectionBuilder : OccupancySectionBuilder
    {
        ...
        internal IKFSkilledNurseSectionBuilder(DateTime reportDate)
        {
            ...
            skilledNurseBudget = new IKFSkilledNurseBudget
            {
                ...
                PrivatePay = OccupancyReportDAO.GetBudgetData(LocationCode.IKF, "HC", "Private Pay", reportDate.Year),
                Medicare = OccupancyReportDAO.GetBudgetData(LocationCode.IKF, "HC", "Medicare", reportDate.Year),
                Medicaid = OccupancyReportDAO.GetBudgetData(LocationCode.IKF, "HC", "Medicaid", reportDate.Year),
                PrivateMedicaidPending = OccupancyReportDAO.GetBudgetData(LocationCode.IKF, "HC", "Private- Medicaid Pending", reportDate.Year)
            };
        }
