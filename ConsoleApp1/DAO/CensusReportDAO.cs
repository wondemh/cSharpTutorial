...
{
    internal static class CensusReportDAO
    {
        internal static Location GetLocation(int id)
        {
        ...
        internal static FacilityType GetFacilityType(int locationId, string facilityTypeCode)
        {
        ...
        internal static AdmissionStatusRecord GetAdmissionStatus(int locationId, string facilityTypeCode, string admissionStatusCode)
        {
        ...
        internal static List<CensusItem> GetCensusRecords(int locationId, DateTime startDate, DateTime endDate, string facilityTypeCode)
        {
        ...
        internal static List<Unit> GetVacantUnits(int locationId, string facilityTypeCode, DateTime date)
        {
            using IDbConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ingAnalyticsConnection"].ConnectionString);
        ...
        internal static int GetCountOfAllUnits(int locationId, string facilityTypeCode)
        {
            using IDbConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ingAnalyticsConnection"].ConnectionString);
